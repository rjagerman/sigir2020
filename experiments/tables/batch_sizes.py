...
def main(args):
    ...
    def create_table(args):
        ...
        for run in avg_runs.values():
            ...
            data[method][dataset][batch_size] ={
                "mean": ys_mean,
                "std": ys_std,
                "n": ys_n
            }
        ...
        # print(r"\begin{tabular}{l@{\hspace{6mm}}rrr@{\hspace{6mm}}rrr}")
        # print(r"\toprule")
        # print(r" & \multicolumn{3}{c}{\Yahoo{}} & \multicolumn{3}{c}{\Istella{}} \\")
        # print(r" & 10 & 20 & 50 & 10 & 20 & 50 \\")
        # print(r"\midrule")
        # for method in ["none", "weight", "sample"]:
        #     result_row = []
        #     print(f"{methods[method]}", end = " & ")
        #     for dataset in ["yahoo", "istella"]:
        #         for batch_size in [10, 20, 50]:
        #             statsig = ""
        #             if method != "weight":
        #                 d1 = data[method][dataset][batch_size]
        #                 d2 = data["weight"][dataset][batch_size]
        ...
        #             result_row.append(f"{100.0 * data[method][dataset][batch_size]['mean']:.2f}{statsig}")
