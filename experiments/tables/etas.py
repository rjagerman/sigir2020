...
def main(args):
    ...
    def create_table(args):
        ...
        for run in avg_runs.values():
            ...
            eta = None
            for t_eta in ["0.5", "0.75", "1.0", "1.25", "1.5"]:
                if f"{t_eta}" in run["args"]["click_log"]:
                    eta = t_eta
        ...
        for dataset in ["yahoo", "istella"]:
            ...
            for method in ["none", "weight", "sample"]:
                ...
                for eta in ["0.5", "0.75", "1.0", "1.25", "1.5"]:
                    statsig = ""
                    if method != "weight":
                        d1 = data[method][dataset][eta]
                        d2 = data["weight"][dataset][eta]
                    ...
                    result_row.append(f"{100.0 * data[method][dataset][eta]['mean']:.2f}{statsig}")
